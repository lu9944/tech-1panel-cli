...
```dotenv
# 面板地址(可包含安全入口路径)
PANEL_URL=http://10.5.0.12:41394/15cbe79efc

# 面板安全入口(也可从 PANEL_URL 路径中自动识别)
PANEL_ENTRANCE=15cbe79efc

# 用户名与密码
PANEL_USERNAME=0bdda45fca
PANEL_PASSWORD=ecd932fbbd
...
# 使用命令行参数(优先级最高)
1panel-cli login --url http://10.5.0.12:41394 --user 0bdda45fca --password 'xxx'
